...
<body>
    <div class="container mt-5">
        ...
        <p><strong>Profile Completed:</strong> {{ session('profile_completed') ? 'Yes' : 'No' }}</p>
        <p><strong>Access Token:</strong> {{ session('access_token') }}</p> <h2>Welcome, {{ session('username') }}</h2>
    </div>
</body>
</html>
...
<div class="container-fluid">
	<!-- Add Project -->
	 <div class="modal fade" id="addProjectSidebar" aria-labelledby="createProjectLabel">
        ...
        <form method="POST" action="">
          ...
          <div class="tab-content">
            ...
            <div class="tab-pane fade" id="technology">
              ...
              <div class="row g-3">
                <div class="col-md-6">
                  ...
                  <select name="backend" class="form-select" required>
                    <option>Select...</option>
                  </select>
                </div>
                <div class="col-md-6">
                  <label>Frontend Technologies</label>
                  <select name="frontend" class="form-select"><option>Select...</option></select>
                </div>
                <div class="col-md-6">
                  <label>Database Technologies</label>
                  <select name="database" class="form-select"><option>Select...</option></select>
                </div>
                <div class="col-md-6">
                  <label>AI Models</label>
                  <select name="ai_models" class="form-select"><option>Select...</option></select>
                </div>
                <div class="col-md-6">
                  <label>APIs</label>
                  <select name="apis" class="form-select"><option>Select...</option></select>
                </div>
                <div class="col-md-6">
                  <label>Programming Languages</label>
                  <select name="languages" class="form-select"><option>Select...</option></select>
                </div>
              </div>
              <hr>
              <h6>Infrastructure</h6>
              <div class="row g-3">
                <div class="col-md-6"><label>Deployment Type</label><select class="form-select"><option>Cloud</option></select></div>
                <div class="col-md-6"><label>Cloud Provider</label><select class="form-select"><option>Select...</option></select></div>
                <div class="col-md-6"><label>Containerization</label><select class="form-select"><option>Select...</option></select></div>
                <div class="col-md-6"><label>APIs & Integrations</label><select class="form-select"><option>Select...</option></select></div>
              </div>
            ...
            <div class="tab-pane fade" id="dataSecurity">
              <h6>Data Sources</h6>
              <div class="row g-3">
                <div class="col-md-4"><label>Structure Type</label><select class="form-select"><option>Select...</option></select></div>
                <div class="col-md-4"><label>Access Type</label><select class="form-select"><option>Select...</option></select></div>
                <div class="col-md-4"><label>Processing Type</label><select class="form-select"><option>Select...</option></select></div>
                <div class="col-md-6"><label>Data Storage Location *</label><select class="form-select" required><option>Select Data Storage Location</option></select></div>
                <div class="col-md-6"><label>Data Sensitivity</label><select class="form-select"><option>Select...</option></select></div>
              </div>
              <hr>
              <h6>Security</h6>
              <div class="row g-3">
                <div class="col-md-3"><label>Data Encryption</label><div class="form-check form-switch"><input type="checkbox" class="form-check-input"></div></div>
                <div class="col-md-6"><label>Access Control</label><select class="form-select"><option>Select...</option></select></div>
                <div class="col-md-3"><label>Audit Logging</label><div class="form-check form-switch"><input type="checkbox" class="form-check-input"></div></div>
                <div class="col-md-6"><label>User Consent Mechanism</label><div class="form-check form-switch"><input type="checkbox" class="form-check-input"></div></div>
              </div>
              <div class="d-flex justify-content-between mt-4">
            ...
            <!-- Tab 4: Compliance & AI/ML -->
            <div class="tab-pane fade" id="compliance">
              <h6>Compliance</h6>
              <div class="mb-3"><label>Compliance Standards</label><select class="form-select"><option>Select...</option></select></div>
              <div class="form-check form-switch"><input class="form-check-input" type="checkbox"> <label class="form-check-label">Bias Risk Factors Identified</label></div>
              <div class="form-check form-switch"><input class="form-check-input" type="checkbox"> <label class="form-check-label">Fairness & Transparency Practices</label></div>
              <div class="form-check form-switch"><input class="form-check-input" type="checkbox"> <label class="form-check-label">Compliance Consultation</label></div>
              <hr>
              <h6>AI & ML</h6>
              <div class="form-check form-switch"><input class="form-check-input" type="checkbox"> <label class="form-check-label">Has AI/ML Components</label></div>
              <div class="form-check form-switch"><input class="form-check-input" type="checkbox"> <label class="form-check-label">Webhooks & Notifications</label></div>
              <div class="form-check form-switch"><input class="form-check-input" type="checkbox"> <label class="form-check-label">Custom Rules</label></div>
              <div class="form-check form-switch"><input class="form-check-input" type="checkbox"> <label class="form-check-label">Third Party Plugins</label></div>
