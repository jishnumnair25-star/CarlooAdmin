<div class="col-xl-3 col-xxl-4 col-lg-4 col-md-6 col-sm-6 items">
	<div class="card contact-bx item-content">
		...
		<div class="card-body user-profile">
			<div class="image-bx">
				<img src="{{ asset('images/contacts/Untitled-11.jpg')}}" alt="" class="rounded-circle">
			...
			<div class="media-body user-meta-info">
				...
				<ul>
					...
					<li><a href="javascript:void(0);"><i class="fa fa-video" aria-hidden="true"></i></a></li>
				</ul>
			</div>
		</div>
	</div>
...
<div class="col-xl-3 col-xxl-4 col-lg-4 col-md-6 col-sm-6 items">
	<div class="card contact-bx item-content">
		...
		<div class="card-body user-profile">
			<div class="image-bx">
				<img src="{{ asset('images/contacts/Untitled-12.jpg')}}" alt="" class="rounded-circle">
				<span class="active"></span>
			</div>
			<div class="media-body user-meta-info">
